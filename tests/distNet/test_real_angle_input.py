...
from ml_qm.distNet.dist_net import ComputeRealAngleInput
...
class TestToInput():
    def setup(self):
        ...
        self.module = ComputeRealAngleInput(data_set.atom_types.n_feature)
            ...
            for nNeigh, (i_idx, j_idx, dist_ij) in batch_ang_neighbor_map.items():
                ...
                if nNeigh == 3:
                    npt.assert_array_almost_equal(desc[4,5],
                        torch.tensor([1.414, 1. , 2.356, 1. , 0. , 0. , 1. , 0. , 0. , 0. , 0. , -1.909, -1.075, 0.707, 0. , 0. ,0.707, 0. , 0. , 0. , 0. , -1.35 , -0.76 , 1. , 0. , 0. , 1. , 0. , 0. , 0. , 0. , -1.909,-1.075]),3)
    ...
    def test_Ang_pad(self):
        ...
        module = ComputeRealAngleInput(data_set.atom_types.n_feature)
                ...
                if nNeigh == 3:
                    ...
                    npt.assert_array_almost_equal(desc[-1,-1],  # a padded example
                        torch.tensor([ conf['angleNet']['angularCutoff'],
                                       2.24,  1.57,  1.  ,  0.  ,  0.  ,  1.  ,  0.  ,  0.  ,  0.  ,  0.  , -1.91, -1.07,  0.31,  0.  ,  0.  ,  0.31,  0.  ,  0.  ,  0.  ,  0.  , -0.6 , -0.34,  0.45,  0.  ,  0.  ,  0.45,  0.  ,  0.  ,  0.  ,  0.  , -0.85, -0.48]),2)
